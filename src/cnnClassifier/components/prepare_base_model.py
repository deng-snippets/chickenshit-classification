...
class PrepareBaseModel:
    ...
    def _prepare_full_model(model, classes, freeze_all, freeze_till, learning_rate):
        logger.info(f'Updating to full model...')
        if freeze_all:
        ...
        logger.info(f'Compiling full model...')
        full_model.compile(
    ...
    def update_base_model(self):
        ...
        logger.info(f'Base model updated and saved at {self.config.updated_base_model_path}')